        ...
        home: `
            ...
            <main>
                ...
                <nav id="view-switcher">
                    <button class="view-button active" data-view="contact">Contact</button>
        ...
        try {
            ...
            if (filteredProjects.length > 0) {
                 container.innerHTML = filteredProjects.map(project => `
                    <a href="${project.html_url}" target="_blank" rel="noopener noreferrer" class="project-card" style="text-decoration: none; color: inherit;">
                        <h3>${project.name}</h3>
